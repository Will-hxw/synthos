...
describe("QQProvider", () => {
    ...
    describe("getMsgByTimeRange", () => {
        ...
        it("图片 picThumbPath 为空但 filePath 存在时应保留本地缓存路径", async () => {
            const mockRow = createMockDbRow();
                ...
                messages: [
                    {
                        ...
                        picType: 1000,
                        picThumbPath: "",
                        filePath: "nt_qq/nt_data/Pic/2026-06/Origin/abc.jpg",
                        originImageMd5: "",
                        imageText: ""
                    }
                ]
            ...
            expect(result[0].mediaItems).toEqual([
                expect.objectContaining({
                    mediaId: `${mockMsgId}:0`,
                    sourceUrl: undefined,
                    sourcePath: path.normalize("nt_qq/nt_data/Pic/2026-06/Origin/abc.jpg")
                })
            ]);
        });
