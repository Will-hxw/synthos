...
### P2-003：README 的 Windows native 依赖故障处理过于简略
...
### P2-004：QQ 数据库路径和 VFS 插件路径对 Docker 用户存在误导
...
### P2-006：Embedding 模型未安装时，只跳过任务，没有前端可见提示
...
### P3-002：项目截图使用 Windows 反斜杠路径，GitHub Markdown 跨平台显示可能不稳定
