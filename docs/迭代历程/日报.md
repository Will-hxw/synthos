...
### common 模块
- `common/services/config/schemas/GlobalConfig.ts` - 新增 `ReportConfigSchema` 配置
- `common/services/database/constants/InitialSQL.ts` - 新增 `createReportTableSQL` 建表语句
- `common/services/database/ReportDbAccessService.ts` - 新增日报数据库管理器
